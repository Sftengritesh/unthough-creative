...
export const packages: Package[] = [
  {
    ...
    price: '₹8,000',
    period: '/MONTH',
    audience: 'Essential presence for growing brands',
    includes: [
      '8 Social Posts & Carousels',
  ...
  },
  {
    ...
    price: '₹10,000',
    period: '/MONTH',
    audience: 'Turn content into a growth engine for your business',
    featured: true,
    includes: [
      '12 High-Impact Short Videos',
      '8 Custom Designed Posts',
      '15 Active Story Frames',
      'Full Page Management & Engagement',
      'Bi-weekly Growth Analytics',
    ],
  },
  {
    name: 'Scale',
    price: '₹15,000',
    period: '/MONTH',
    audience: 'Maximum reach & brand dominance',
    includes: [
      '20 High-Impact Short Videos',
      '16 High-Conversion Posts / Carousels',
      'Dedicated Content Director',
      '360° Omnichannel Direction',
